...
import (
	...
	"github.com/afonsocraposo/advent-of-code/internal/utils/animation"
	...
	"github.com/afonsocraposo/advent-of-code/internal/utils/re"
)
...
func part1() {
	f := filereader.NewFromDayInput(2024, 18, 1)
	M, N := 71, 71
	FALLEN_BYTES := 1024
